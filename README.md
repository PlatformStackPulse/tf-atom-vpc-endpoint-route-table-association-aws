# tf-atom-vpc-endpoint-route-table-association-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws/releases)

---

## Purpose

Terraform atom module for a single AWS VPC Endpoint Route Table Association resource. Associates a Gateway VPC endpoint with a route table to enable traffic routing.
...
module "vpc_endpoint_route_table_association" {
  source = "git::https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-route-table-association-aws.git?ref=v1.1.0"
...
|------|-------------|------|---------|:--------:|
| <a name="input_route_table_id"></a> [route\_table\_id](#input\_route\_table\_id) | ID of the route table to associate with the VPC endpoint. | `string` | n/a | yes |
| <a name="input_vpc_endpoint_id"></a> [vpc\_endpoint\_id](#input\_vpc\_endpoint\_id) | ID of the VPC endpoint to associate with the route table. | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_association_id"></a> [association\_id](#output\_association\_id) | The ID of the VPC Endpoint Route Table Association. |
